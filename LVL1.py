...
def precip_smooth_Nayak2010(precip):
    '''
...
def average_and_checkNayakSmoothing(smooth_forwards, smooth_backwards):
    '''
    smooth forwards
    '''
    

#precip[ii] for ii in list(range(3,len(precip)-3))

#TOMORROW - do for loop as list comprehension!
...
#         
# [xx for ]   
##smooth_forward=precip_smooth_Nayak2010(TPGdat.TPGIncremental)
##
##smooth_backward=precip_smooth_Nayak2010(TPGdat.TPGIncremental.sort_index(ascending=False))


#TPGdat=pd.read_csv('C:\\Users\\ehbaker\\Desktop\\DatatoUse Separate.csv')

#lst=[1, 30, 40, 2, 7, 8, 9, 22, 7]
#    
